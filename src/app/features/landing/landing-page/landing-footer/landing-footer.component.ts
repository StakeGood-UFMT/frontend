    ...
    <footer class="footer" id="footer">
      <div class="footer-inner">
        ...
        <div class="footer-brand">
          ...
          <p class="brand-tagline">Mercado preditivo com impacto social real na blockchain Stellar.</p>
        ...
        <div class="footer-links">
          <div class="links-col">
            <span class="col-title">Produto</span>
            <a routerLink="/arena" class="footer-link">Arena</a>
            <a routerLink="/landing" class="footer-link">Como funciona</a>
          </div>
          <div class="links-col">
            <span class="col-title">Comunidade</span>
          ...
          <div class="links-col">
            ...
            <a routerLink="/onboarding/terms" class="footer-link">Termos de Uso</a>
      ...
      <div class="footer-bottom">
        <span>© 2025 StakeGood — UFMT. Todos os direitos reservados.</span>
